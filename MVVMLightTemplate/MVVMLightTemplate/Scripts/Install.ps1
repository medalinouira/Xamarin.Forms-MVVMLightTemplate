...
#			[System.Windows.MessageBox]::Show("No locator found")
	...
	if ($isUniversal)
	{
		# add the required .NET assembly:
		Add-Type -AssemblyName PresentationFramework 
		[System.Windows.MessageBox]::Show('This is a Universal application. You need to move the ViewModel folder manually. See http://www.mohamedalinouira.com for details')
		
		$ie = New-Object -ComObject InternetExplorer.Application
		$ie.Navigate("http://www.mohamedalinouira.com")
		$ie.Visible = $true
	}
}
